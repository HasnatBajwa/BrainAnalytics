    ...
    <div className="benefits-container">
      <Grid className="benefits-data" container justifyContent="center">
        <Grid item xs={4} sm={4} md={4}>
          <h1 className="benefits-heading-1">Benefits</h1>
        ...
        <Grid item xs={4} sm={4} md={4}>
          ...
          <h2 className="benefits-heading-2">Amazing Learning Ecosystem</h2>
          <p className="benefits-txt">
        ...
        <Grid item xs={4} sm={4} md={4}>
          <div className="benefits-bar"> </div>
          <h2 className="benefits-heading-2">Expert Instructors</h2>
          <p className="benefits-txt">
            Through their guidance and support, Our Instructors play a
            crucial role in helping their students achieve their goals and
