...
const SocialMedia = () => {
  return (
    <div data-aos='fade-in' className="socialmedia-container">
      <Grid container>
        ...
        <div className="socialmedia-icon-container">
          ...
          <img
            src={Instagram}
            alt="Instagram"
            className="socialmedia-icon ig"
          />
          <img
            src={WhatsApp}
            alt="WhatsApp"
            className="socialmedia-icon wa"
          />
          <img
            src={LinkedIn}
            alt="LinkedIn"
            className="socialmedia-icon li"
          />
          <img
            src={Twitter}
            alt="Twitter"
            className="socialmedia-icon tw"
          />
        </div>
      </Grid>
    </div>
